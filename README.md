...
The Add Ons depend on the ScriptMaster plugin by 360works, downloadable from their website [https://www.360works.com/scriptmaster/](www.360works.com/scriptmaster/) for free. Put the extracted plugin into the Extension folder of FileMaker. It then should be listet in the plugins tab of the settings dialog.
