...
//	private static Logger logger = LoggerFactory.getLogger(Camt.class);
	...
	public static String convertCamt(String request)
	{
	...
	private static boolean doConvertCamt()
	{
		boolean result = true;
...
//	public static String extract(String request) throws JsonMappingException, JsonProcessingException
//	{
//		if (createRequestNode(request))
//		{
//			doExtract();
...
//	}
//	
//	public static String extractTags(String request)
//	{
//		if (createRequestNode(request))
//		{
//			doExtract();
...
//	private static boolean doExtract()
//	{
//		boolean result = true;
...
//	private static boolean doExtractTags()
//	{
//		boolean result = true;
...
//	}
	...
	private static String extractIdentifier(String json)
	{
